...
const Finished = () => {
	...
	return (
		<main className="min-h-screen text-white max-w-7xl">
			<section className="grid grid-cols-1 gap-4 p-4 sm:grid-cols-6">
				<form className="rounded-lg min-h-content p-4 bg-[#2a302f] sm:col-span-6 lg:col-start-2 lg:col-end-6">
					...
					<div className="mt-6">
						<h3 className="text-sm italic">Address of receiver</h3>
						<input
							id="account"
							type="text"
					...
					<div className="mt-6">
						<h3 className="text-sm italic">Number amount</h3>
						<input
							id="amount"
							type="number"
							min={0}
